...
//租户列表的接口
Mock.mock('https://www.demo.com/userList', 'post', (options) => {
...
//删除企业
Mock.mock('https://www.demo.com/deleteUser', 'post', (options) => {
...
//批量删除企业
Mock.mock('https://www.demo.com/batchDeleteUser', 'post', (options) => {
...
//编辑企业
Mock.mock('https://www.demo.com/editUser', 'post', (options) => {
...
Mock.mock('https://www.demo.com/roomList', 'post', (options) => {
...
//合同管理
Mock.mock('https://www.demo.com/contractList', 'post', (options) => {
...
//账单管理
Mock.mock('https://www.demo.com/billList', 'post', (options) => {
...
//账号管理
Mock.mock('https://www.demo.com/accountList', 'post', (options) => {
