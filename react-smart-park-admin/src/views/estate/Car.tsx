...
import { Button, Card, Col, Form, Image, Input, Row, Table, Tabs } from 'antd'
  ...
  },
  {
    ...
    render: () => (
      <Image
        src={logo}
        width={50}
        placeholder={<Image preview={false} src={logo} width={150} />}
      />
    )
  },
...
const Car = () => {
  return (
    <Row>
      <Col span={24}>
        <Card>
          <Form layout="inline" name="basic" autoComplete="off">
